<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" data-color="dark" id="sidenav-main">
  ...
  <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item pb-2">
        <a class="nav-link {{ Route::currentRouteName() == 'accueil' ? 'active' : '' }}" href="{{ route('accueil') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="16px" height="16px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>shop </title>
      ...
      <li class="nav-item">
        <a class="nav-link {{ Route::currentRouteName() == 'évènement' && Route::current()->parameters() == [] ? 'active' : '' }}" href="{{ route('évènement') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <i style="font-size: 1rem; margin-right:1px; margin-bottom:4px;" class="fa fa-calendar-check ps-2 pe-2 text-center
                        {{ in_array(
    ...
    ? 'text-white'
    : 'text-dark' }}"></i>
            {{-- <i class="fa fa-calendar-check py-2" style="font-size: 1rem !important"> </i> --}}
          </div>
