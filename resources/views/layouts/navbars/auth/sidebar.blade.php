<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
    data-color="dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'accueil' ? 'active' : '' }}"
                    href="{{ route('accueil') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="16px" height="16px" viewBox="0 0 45 40" version="1.1"
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'ajouter des hôtes' ? 'active' : '' }}"
                    href="{{ route('ajouter des hôtes', [2]) }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg class="text-dark" width="16px" height="16px" viewBox="0 0 40 44" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="nav-link-text ms-1">Ajouter hote</span>
                </a>
            </li>
    ...
    {{-- <div class="sidenav-footer mx-3 mt-3 pt-3">
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            ...
            <div class="card-body text-left p-3 w-100">
                ...
                <div class="docs-info">
                    <h6 class="text-white up mb-0">Remercier Arnaud ?</h6>
                    <p class="text-xs font-weight-bold">Envoie lui des cadeaux</p>
