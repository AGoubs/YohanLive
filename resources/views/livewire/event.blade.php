                    ...
                    <div class="responsive-view-table">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        <th class="column1 text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" data-content="Nom">
                                            Nom
                                        </th>
                                        <th class="column2 text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2" data-content="Date">
                                            Date
                                        </th>
                                        <th class="column4 text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                            Heure de l'évènement
                                        </th>
                                        <th class="column3 text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                            Heure d'arrivé
                                        </th>
                                        <th class="column5 text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="column2 text-center-responsive" data-content="Date">
                                            @if ($event->Date < date('Y-m-d')) <span class="badge badge-sm badge-danger">{{ date('d/m/Y', strtotime($event->Date)) }}</span>
