    ...
    <div class="row">
      <div class="col-12 col-lg-8 m-auto">
        <form wire:submit.prevent="updateEvent" action="#" method="POST" class="multisteps-form__form "
          style="height: 400px;" asp-action="Create">
          <div class="card multisteps-form__panel p-3 border-radius-xl bg-white js-active" data-animation="FadeIn">
            ...
            <div class="row mt-3">
              <div class="col-12 col-sm-6">
                ...
                <input type="text" class="form-control @error('Nom') border border-danger  @enderror" wire:model="Nom"
                  autofocus />
            ...
            <div class="row mt-3">
              <div class="col-12 col-sm-4">
                ...
                <input type="time" class="form-control @error('HeureEvenement') border border-danger  @enderror"
              ...
              <div class="col-12 col-sm-4 mt-3 mt-sm-0">
                ...
                <input type="time" class="form-control @error('HeureArrive') border border-danger  @enderror"
              ...
              <div class="col-12 col-sm-4 mt-3 mt-sm-0">
                ...
                <select class="multisteps-form__select form-control" id="type_event" style="background-color: white"
                  wire:model="type_event">
        ...
        <div class="col-12">
          <a href="{{ route('évènements') }}" class="btn btn-default" type="button"><i
